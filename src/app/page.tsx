...
const artworks = [
  {
    ...
    description:
      "A meditative composition exploring movement, stillness, and emotional restraint through softened tonal layers.",
  },
  {
    id: 2,
    title: "Soft Geometry",
    ...
    description:
      "Structured planes and muted contrasts create a work that feels both architectural and intimate.",
  },
  {
    id: 3,
    ...
    description:
      "An intimate study of memory and landscape, balancing softness with precise material detail.",
  },
  {
    id: 4,
    title: "Nocturne in White",
    artist: "Rafi Kurnia",
    year: "2020",
    genre: "Minimalism",
    material: "Pigment on board",
    style: "Monochrome",
    availability: "Not for sale",
    image:
      "https://images.unsplash.com/photo-1545239351-1141bd82e8a6?auto=format&fit=crop&w=1200&q=80",
    description:
      "A restrained monochromatic work that draws attention to texture, balance, and silence.",
  },
  {
    id: 5,
    title: "Red Interval",
    ...
    year: "2024",
    genre: "Abstract",
    material: "Oil and chalk on canvas",
    style: "Abstract",
    availability: "Available",
    image:
      "https://images.unsplash.com/photo-1578301978693-85fa9c0320b9?auto=format&fit=crop&w=1200&q=80",
    description:
      "A bold but composed composition that uses interruption and rhythm to guide the eye.",
  },
  {
    id: 6,
    title: "Still Room",
    artist: "Bintang Rahadi",
    year: "2022",
    genre: "Interior",
    ...
    description:
      "A contemplative interior scene emphasizing atmosphere, proportion, and quiet human presence.",
  },
  {
    id: 7,
    title: "Blue Memory",
    artist: "Nadia Santoso",
    year: "2021",
    genre: "Abstract",
    ...
    description:
      "A layered blue surface that reveals subtle shifts in tone and a deeply reflective mood.",
  },
  {
    id: 8,
    title: "Line & Air",
    artist: "Farah Nugroho",
    year: "2023",
    genre: "Drawing",
    ...
    image:
      "https://images.unsplash.com/photo-1547891654-e66ed7ebb968?auto=format&fit=crop&w=1200&q=80",
    description:
      "A pared-down work that reflects the collector's preference for clarity, rhythm, and spatial tension.",
  },
];
...
export default function App() {
  ...
  const [form, setForm] = useState({
    ...
    email: "",
    phone: "",
    message: `Hello, I am interested in ${artworks[0].title}. I would like to learn more about its availability and arrange a viewing if possible.`,
  });
        ...
        <section style={{ ...styles.shell, ...responsive.hero }}>
          <motion.div initial={{ opacity: 0, y: 18 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.45 }}>
            <div style={styles.heroImageWrap}>
              <img src={selectedArtwork.image} alt={selectedArtwork.title} style={styles.image} loading="eager" />
            </div>
          </motion.div>
